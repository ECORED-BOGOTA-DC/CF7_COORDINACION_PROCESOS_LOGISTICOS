  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9(data-aos="fade-left")
        .titulo-segundo
          h2 Flujo de mercancías
        p.mb-4 Optimizar el flujo de mercancías en el transporte terrestre, minimizando costos y cumpliendo con decretos, para mejorar eficiencia y rentabilidad en la cadena de suministro.
